...
namespace
{
	...
	const FName DataBakeSettingsSectionName(TEXT("FoliageBakerDataBake"));
	...
	public:
		...
		virtual void CustomizeDetails(IDetailLayoutBuilder& DetailBuilder) override
		{
			...
			DetailBuilder.HideProperty(
				GET_MEMBER_NAME_CHECKED(UFoliageBakerTreeHierarchySettings, SourceStaticMesh),
				UFoliageBakerTreeHierarchySettings::StaticClass());
			DetailBuilder.HideProperty(
				GET_MEMBER_NAME_CHECKED(UFoliageBakerTreeHierarchySettings, SourceLODIndex),
				UFoliageBakerTreeHierarchySettings::StaticClass());
			DetailBuilder.HideProperty(
				GET_MEMBER_NAME_CHECKED(UFoliageBakerTreeHierarchySettings, VoxelResolution),
				UFoliageBakerTreeHierarchySettings::StaticClass());
		}
	};
	...
	const TArray<FFoliageBakerEditorPreferenceDescriptor>& GetEditorPreferenceDescriptors()
	{
		...
		{
			{
				DataBakeSettingsSectionName,
				LOCTEXT("DataBakeSettingsName", "Foliage Baker - Data Bake"),
				LOCTEXT(
					"DataBakeSettingsDescription",
					"Configure the pivot hierarchy generated by Data Bake hierarchy analysis."),
				UFoliageBakerTreeHierarchySettings::StaticClass()
			},
			{
...
{
	EnsureDataBakeSettings();
	const UFoliageBakerTreeHierarchySettings& DataBakePreferences =
		*GetDefault<UFoliageBakerTreeHierarchySettings>();
	const bool bGenerateSubbranches =
		DataBakePreferences.PivotHierarchy
